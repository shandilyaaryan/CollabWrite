...
export const Toolbar = () => {
    ...
    [
      {
        ...
        isActive: editor?.isActive("liveblocksComentMark"),
      },
      {
        label: "List Todo",
        icon: ListTodoIcon,
  ...
  return (
    <div className="bg-[#F1F4F9] px-2.5 py-0.5 rounded-[24px] min-h-[40px] flex items-center gap-x-0.5 overflow-x-auto -z-50">
      {sections[0].map((item) => (
        <ToolbarButton key={item.label} {...item} />
      ))}
      <Separator
        orientation="vertical"
        className="h-5 w-[1px] bg-neutral-300"
      />
      <FontFamilyButton />
      <Separator
        orientation="vertical"
