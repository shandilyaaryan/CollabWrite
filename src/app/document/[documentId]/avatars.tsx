...
const Avatar = ({ src, name }: AvatarProps) => {
  return (
    ...
    >
      <div className="opacity-0 hover:opacity-100 absolute top-full px-2 py-1 text-white text-xs rounded-lg mt-2.5 z-10 bg-black whitespace-nowrap transition-opacity">
        {name}
      </div>
