...
export const SearchInput = () => {
    ...
    return(
        <div className="flex-1 flex items-center justify-center">
            ...
            >
                <Input value={value} onChange={handleChange} ref={inputRef} placeholder="Search"
                ...
                {value && (
                    <Button type="button" variant="ghost" size="icon" onClick={handleClear} className="absolute right-3 top-1/2 -translate-y-1/2 [&_svg]:size-5 rounded-full">
                    <XIcon />
                    </Button>
                )}
            </form>
